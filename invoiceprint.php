...
<body>
	...
	$type_of_room = 0;
	if ($troom == "SUPERIOR MODE") {
		$type_of_room = 5000;
	} else if ($troom == "PREMIUM MODE") {
		$type_of_room = 3000;
	} else if ($troom == "FREEMIUM MODE") {
		$type_of_room = 2000;
	} else if ($troom == "FREE MODE") {
		$type_of_room = 1000;
	}

	if ($bed == "1 Months") {
		$type_of_bed = $type_of_room * 1 / 100;
	} else if ($bed == "3 Months") {
		$type_of_bed = $type_of_room * 2 / 100;
	} else if ($bed == "6 Months") {
	...
	<header>
		...
		<span><img alt="" src="../image/xevwibsa.png"></span>
	</header>
	<article>
		<h1>Recipient</h1>
		<address>
	...
	<aside>
		...
		<div>
			<p align="center">Email :- vrajshukla03@gmail.com || Web :- www.virtualartistshouse.com || Phone :- +91 8141546464 </p>
		</div>
	</aside>
