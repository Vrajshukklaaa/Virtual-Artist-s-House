...
<body>
    ...
    <section id="carouselExampleControls" class="carousel slide carousel_section" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="carousel-image" src="./image/Virtual Artist's House.png">
            </div>
            <!-- <div class="carousel-item">
                <img class="carousel-image" src="./image/PurpleSense.png">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/ArtUncommon.png">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/TheAmbassadors.png">
            </div> -->
        </div>
    </section>
    ...
    <section id="auth_section">
        ...
        <div class="logo">
            <img class="bluebirdlogo" src="./image/xevwibsa.png" alt="logo">
