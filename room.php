...
<body>
    <div class="addroomsection">
        <form action="" method="POST">
            <label for="troom">Type of Course :</label>
            ...
            <label for="bed">Course Name :</label>
            ...
            <button type="submit" class="btn btn-success" name="addroom">Add Course</button>
        </form>
