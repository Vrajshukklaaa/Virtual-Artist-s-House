...
<body>
    ...
    <nav class="sidenav">
        <ul>
            ...
            <li class="pagebtn"><img src="../image/icon/onlinecourse.png">&nbsp&nbsp&nbsp Course Booking</li>
            <li class="pagebtn"><img src="../image/icon/wallet.png">&nbsp&nbsp&nbsp Payment</li>            
            <li class="pagebtn"><img src="../image/icon/readingbook.png">&nbsp&nbsp&nbsp Courses</li>
